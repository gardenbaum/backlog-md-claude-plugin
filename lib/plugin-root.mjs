 ...
 * inside Claude Code, and the cache scan survives an update nobody announced.
 *
 ...
 *
 * @param {{ configured?: string | null, hint?: string | null, env?: NodeJS.ProcessEnv, home?: string }} [options]
 * @returns {string[]}
 */
export function pluginRootCandidates({ configured, hint, env = process.env, home } = {}) {
  ...
  return [...explicit, ...cachedInstalls(home ?? safeHome())];
}
