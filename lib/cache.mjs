...
/** Session snapshots, deliberately outside the repository so they never reach the user's diffs. */
export function cacheDir(repoRoot) {
  const key = createHash("sha256").update(String(repoRoot)).digest("hex").slice(0, 16);
